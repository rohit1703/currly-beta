  ...
  return (
    <div className="p-8 max-w-2xl">
      <div className="flex items-center justify-between mb-1">
        ...
        <DeleteButton
          action={deleteTool.bind(null, id)}
          confirmMessage={`Delete "${tool.name}"? This cannot be undone.`}
          label="Delete Tool"
          className="text-sm text-red-400 hover:text-red-300 border border-red-400/30 px-4 py-2 rounded-xl transition-colors disabled:opacity-50"
        />
      </div>
