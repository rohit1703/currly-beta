    ...
    <div className="min-h-screen bg-[#F5F5F7] dark:bg-black text-black dark:text-white font-sans selection:bg-[#0066FF] selection:text-white overflow-x-hidden transition-colors duration-300">
      ...
      <main className="relative z-10">
        ...
        <header className="container mx-auto px-4 py-24 md:py-40 text-center">
          ...
          <div className="max-w-2xl mx-auto text-lg md:text-2xl leading-relaxed text-gray-900 dark:text-gray-300 font-medium px-4">
            <p>
          ...
          <div className="max-w-5xl mx-auto rounded-[2rem] border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 overflow-hidden shadow-2xl dark:shadow-none">
            <div className="grid md:grid-cols-2">
              <div className="relative h-[400px] md:h-auto border-b md:border-b-0 md:border-r border-gray-200 dark:border-white/10">
                 <img src="/founders.jpg" alt="Rohit and Ashish" className="absolute inset-0 w-full h-full object-cover object-top grayscale hover:grayscale-0 transition-all duration-700" />
              </div>
              <div className="p-10 md:p-16 flex flex-col justify-center space-y-12 bg-white dark:bg-transparent">
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-400 text-sm leading-relaxed font-medium">The engineer who thinks like a researcher. Rohit builds the intelligence layer—the extraction engine and semantic search pipeline. He believes great products are built on systems &gt; features.</p>
                </div>
                <div>
                  <div className="flex justify-between items-center mb-2">
                  ...
                  <p className="text-xs font-bold text-[#0066FF] uppercase tracking-wider mb-4">Co-founder, Currly</p>
                  <p className="text-gray-700 dark:text-gray-400 text-sm leading-relaxed font-medium">The strategist who thinks like a storyteller. Ashish shapes Currly&apos;s positioning and principles. He believes trust isn&apos;t marketed—it&apos;s earned.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="container mx-auto px-4 mb-24">
          <div className="relative rounded-[2.5rem] bg-gradient-to-b from-[#0066FF] to-blue-900 overflow-hidden text-center px-6 py-24 md:py-32 shadow-2xl">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <p className="text-blue-100 text-xl mb-12 font-medium">No affiliate bias. No marketing fluff. Just honest discovery.</p>
