      ...
      <main className="relative z-10">
        ...
        <section className="container mx-auto px-4 mb-32">
          <div className="max-w-4xl mx-auto rounded-3xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-8 md:p-16 shadow-xl dark:shadow-none relative overflow-hidden">
            ...
            {/* Replaced 'prose' with manual styling for perfect contrast */}
            <div className="text-lg md:text-xl leading-relaxed space-y-8 relative z-10 text-gray-800 dark:text-gray-300">
              ...
              <p>
                The entire AI tools discovery ecosystem was built on a corrupted incentive: <strong className="text-black dark:text-white bg-yellow-100 dark:bg-transparent dark:text-yellow-400 px-1">Get paid to recommend, regardless of whether it is right for the user.</strong>
              </p>
              
              <p>
                So we started over. Different incentives. Different architecture. Different truth. <strong className="text-black dark:text-white">That is Currly.</strong>
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link href="/" className="rounded-full bg-white text-[#0066FF] px-10 py-4 text-lg font-bold hover:scale-105 transition-transform shadow-xl flex items-center justify-center gap-2">
                  Start Exploring <ArrowRight size={