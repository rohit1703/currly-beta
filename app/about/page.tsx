    ...
    <div className="min-h-screen bg-[#F5F5F7] dark:bg-black text-black dark:text-white font-sans selection:bg-[#0066FF] selection:text-white overflow-x-hidden transition-colors duration-300">
      ...
      <main className="relative z-10">
        ...
        <header className="container mx-auto px-4 py-16 md:py-40 text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white dark:bg-[#0066FF]/10 dark:border-[#0066FF]/30 px-3 py-1 text-[10px] md:text-xs font-bold uppercase tracking-wider text-[#0066FF] mb-6 md:mb-8 shadow-sm">
        ...
        {/* Rest of the page content stays the same as before... keeping it concise for this paste */}
        {/* Ensure you keep the Problem, Non-Negotiables, Founders, Vision, FAQ, and CTA sections here. */}
        {/* If you need the full file content again for About, ask. But the Header fix above solves the mobile text size issue. */}
      </main>
    </div>
  );
}